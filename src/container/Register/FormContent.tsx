    ...
    <>
      <div className="flex flex-col justify-between  w-1/2  ">
        ...
        <div className="mr-20 ">
          ...
          <div className="">
            <input
              className="w-[256px] !important h-[56px] rounded-[8px] p-4 shadow-md "
              type="text"
              placeholder="نام"
            />
            <input
        ...
        <div className="mr-14 flex flex-col w-[200px] p-5  ">
          ...
          <div className="relative mt-3 ">
            ...
            <button className="btn absolute right-[472px] bg-[#003D57]  -mt-14 text-white rounded-[8px] w-[89px] h-[56px] ">
              تایید ایمیل
            </button>
          </div>
