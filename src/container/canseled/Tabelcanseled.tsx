      ...
      <table className="min-w-full border-collapse mt-[4%]  ">
        <thead>
          <tr className="bg-[#4A4A4A] rounded-t-xl">
            ...
            <th className=" px-4 py-2">ساعت رزرو</th>
            <th className=" px-4 py-2">وضعیت پرداخت</th>
            <th className=" px-4 py-2">تاریخ لغو</th>
            <th className=" px-4 py-2">شماره شبا</th>
            <th className=" px-4 py-2 rounded-tl-lg">وضغیت بازگشت وجه</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-2 flex justify-center">
              <button className=" w-[105px] h-[36px] bg-[#FF4B4B] rounded-[8px] mt-auto">
                انجام نشده
              </button>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-2">ردیف 2-7</td>
            <td className="border border-gray-300 px-4 py-2 flex justify-center">
              <button className=" w-[105px] h-[36px] bg-[#269200] rounded-[8px] mt-auto">
                انجام شده
              </button>
            </td>
          </tr>
