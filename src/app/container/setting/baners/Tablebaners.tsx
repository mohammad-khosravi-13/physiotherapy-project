        ...
        <table className="min-w-full border-collapse rounded-t-2xl relative top-10 ">
          <thead>
            <tr className=" rounded-tr-2xl text-white text-[14px]">
              ...
              <th className=" px-4 py-2 bg-[#4A4A4A]">بنر</th>
              <th className=" px-4 py-2 bg-[#4A4A4A]">ابعاد بنر </th>
              <th className=" px-4 py-2 bg-[#4A4A4A]">عنوان بنر</th>
