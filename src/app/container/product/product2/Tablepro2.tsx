...
import massege from '../../../svg/Message 18.svg'
function Tablepro2() {
  return (
    <div>
      <table className="min-w-[97%] border-collapse rounded-t-2xl relative top-10 ">
        <thead>
          <tr className=" rounded-tr-2xl">
            ...
            <th className=" px-4 py-2 bg-[#4A4A4A]">عنوان پیام</th>
            <th className=" px-4 py-2 bg-[#4A4A4A]">متن پیام</th>
            <th className=" px-4 py-2 bg-[#4A4A4A]"> وضعیت</th>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-4 ">
              <span className=" flex justify-around">
                ...
                <Image src={massege} alt="masseg icon" width={24} height={24} />
              </span>
            </td>
          </tr>
          <tr>
      ...
      <div className=" w-[97%] flex justify-between relative top-14  ">
        <div>
